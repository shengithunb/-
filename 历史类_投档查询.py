"""
广东省2025年高考历史类投档数据查询工具
1. 从PDF提取数据存入SQLite
2. 查询排位50000~90000的院校
"""

import fitz, sqlite3, re, os

# ===== 修改这里为你的实际文件路径 =====
PDF_PATH = r"广东省2025年本科普通类（历史）投档情况.pdf"
# ====================================

DB_PATH = os.path.splitext(PDF_PATH)[0] + ".db"
RESULT_FILE = "历史类_排位5万_9万.csv"
...
def export_query(db_path, output_file):
    ...
    c.execute('''
        ...
        FROM tou_dang
        WHERE min_rank BETWEEN 50000 AND 90000
...
if __name__ == '__main__':
    ...
    print(f"排位50000~90000共 {len(rows)} 条记录，已导出到 {RESULT_FILE}")
